...
通过服务端渲染，可以优化SEO抓取，提升首页加载速度，提升用户体验等。由于我vue还可以，所以上手还是比较轻松的，通过几天的学习，我先是把nuxt.js 做了下整理，然后在B站找了项目实战撸了一把，所以想通过这篇文章，对其中的模块实现做一下总结，同时希望能够对学习SSR的小伙伴起到一点帮助。如果你觉得本文还行，请点亮左边的👍
## 二、nuxt基础
### 1. 概念
...
![](https://user-gold-cdn.xitu.io/2020/5/19/1722c3ac4a760614?w=1847&h=127&f=png&s=23901)
### 4. 项目技术亮点
...
```
##### 2. 数据库（Redis & MongoDB）& 腾讯邮箱SMTP服务相关配置
在config.js文件中进行配置工作
...
![](https://user-gold-cdn.xitu.io/2020/5/20/172302a0ef3c0ba1?w=1272&h=791&f=png&s=54347)
